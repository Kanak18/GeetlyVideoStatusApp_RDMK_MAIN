...
public class NV_RatingDialog extends AppCompatDialog implements OnRatingBarChangeListener, OnClickListener {
    ...
    public void openPlaystore(Context context) {
        try {
            ...
            new NV_SessionManager(context).setBooleanData(NV_SessionManager.PREF_APP_RATED, Boolean.valueOf(true));
    ...
    public void setRatingThresholdClearedListener() {
        this.builder.ratingThresholdClearedListener = new Builder.RatingThresholdClearedListener() {
            public void onThresholdCleared(NV_RatingDialog swaNVRatingDialog, float f, boolean z) {
                swaNVRatingDialog = NV_RatingDialog.this;
                swaNVRatingDialog.openPlaystore(swaNVRatingDialog.context);
                NV_RatingDialog.this.dismiss();
            }
        };
    }
    ...
    public void setRatingThresholdFailedListener() {
        this.builder.ratingThresholdFailedListener = new Builder.RatingThresholdFailedListener() {
            public void onThresholdFailed(NV_RatingDialog swaNVRatingDialog, float f, boolean z) {
                NV_RatingDialog.this.openForm();
            }
        };
    }
    ...
    NV_RatingDialog(Context context, Builder builder) {
        super(context);
    ...
    static class Builder {
        ...
        NV_RatingDialog build() {
            return new NV_RatingDialog(this.context, this);
        }

        Builder feedbackTextColor(int i) {
