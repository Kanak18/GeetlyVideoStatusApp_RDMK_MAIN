...
public class NvAlbumAdapter extends Adapter<NvAlbumAdapter.MyViewHolder> {
    ...
    private void nativeAd(final MyViewHolder myViewHolder, final int i) {
        ...
        builder.forNativeAd(unifiedNativeAd -> {
            ...
            NvAlbumAdapter.this.populateUnifiedNativeAdView(unifiedNativeAd, (NativeAdView) relativeLayout.findViewById(R.id.unified));
    ...
    public void onBindViewHolder(MyViewHolder myViewHolder, final int i) {
        ...
        if (itemViewType == 0) {
            ...
            if(MyApplication.show_native > 0 && !TextUtils.isEmpty(MyApplication.native_ad_id)) {
    ...
    @SuppressLint("MissingPermission")
    private void loadNativeAds(final FrameLayout frameLayout, final NativeAdView nativeAdLayout) {
        Builder builder = new Builder((Context) mContext, native_ad_id);
        builder.forNativeAd(unifiedNativeAd -> {
            if (nativeAd != null) {
                nativeAd.destroy();
            }
    ...
    public void setupDialog(ViewHolder myViewHolder) {
        ...
        btnYes.setOnClickListener(view -> {
            ...
            if (NvAlbumAdapter.this.arrayList.size() > item) {
    ...
    public void removeAt(int position) {
        ...
        String sdCardUri = NvAlbumAdapter.this.arrayList.get(position);
        ...
        NvAlbumAdapter.this.arrayList.remove(position);
        notifyItemRemoved(position);
        notifyItemRangeChanged(position, NvAlbumAdapter.this.arrayList.size());
    }
