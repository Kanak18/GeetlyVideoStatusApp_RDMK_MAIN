...
public class Utils_VideoDownload {
    ...
    public Utils_VideoDownload(Context context, String url, int isShare, int tag, int quoteId) {
        ...
        if (new File(location).exists()) {
            ...
            if (isShare == 1) {
                ...
                new Util_ImageShare(context, location, tag);
